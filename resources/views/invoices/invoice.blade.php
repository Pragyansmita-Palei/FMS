...
<tr>
<td class="party-col">
<strong>Invoice By - {{ config('app.name') }}</strong><br>
Phone - {{ config('company.phone') ?? '-' }}<br>
Address - {{ config('company.address') ?? '-' }}
</td>

<td class="party-col">
<strong>Invoice To - {{ optional($project->customer)->name ?? '-' }}</strong><br>
...
{{-- FETCH TOTALS FROM QUOTATION TABLE --}}
@php
...
2. Taxes applicable as per rules.<br>
