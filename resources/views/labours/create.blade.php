    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-semibold mb-0">Add New Labour</h5>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="rate_type"
                            ...
                            <option value="day" {{ old('rate_type') == 'day' ? 'selected' : '' }}>
                                Per Day
                            </option>
                            <option value="hour" {{ old('rate_type') == 'hour' ? 'selected' : '' }}>
                                Per Hour
                            </option>
                        </select>
                    </div>
